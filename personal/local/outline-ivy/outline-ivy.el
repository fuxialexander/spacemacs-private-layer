...
(defface oi-face-1 '((t :foreground "#9E6FB8" :weight ultra-bold :italic t :underline t)) "Ivy outline face for level 1")
(defface oi-face-2 '((t :foreground "#FF7D76" :weight extra-bold :italic t :underline t)) "Ivy outline face for level 2")
(defface oi-face-3 '((t :foreground "#A9CC00" :weight bold :italic t :underline t)) "Ivy outline face for level 3")
(defface oi-face-4 '((t :foreground "#FF7D76" :weight bold :italic t)) "Ivy outline face for level 4")
(defface oi-face-5 '((t :foreground "#A9CC00" :weight bold :italic t)) "Ivy outline face for level 5")
(defface oi-face-6 '((t :foreground "#AF7BCC" :weight bold :italic t)) "Ivy outline face for level 6")
(defface oi-face-7 '((t :foreground "#FFBF19" :weight bold :italic t)) "Ivy outline face for level 7")
(defface oi-face-8 '((t :foreground "#4BA8AF" :weight bold :italic t)) "Ivy outline face for level 8")
